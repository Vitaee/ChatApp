...
Future<List<DirectMessages>?> getMessages(String roomName) async {
  ...
  BaseOptions options = BaseOptions(
      baseUrl: "http://10.80.1.167:8080/api/messages/$roomName/",
  ...
  try {
    final res =
        ...
        await dio.get("http://10.80.1.167:8080/api/messages/$roomName/");

    final List parsed = json.decode(res.data);

    List<DirectMessages> list =
        await parsed.map((e) => DirectMessages.fromJson(e)).toList();
